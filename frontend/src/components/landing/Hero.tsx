      ...
      <div className="relative z-10 text-center px-4 max-w-5xl mx-auto">
        ...
        >
          <div className="inline-flex items-center gap-3 bg-gradient-to-r from-blue-500/10 to-purple-500/10 backdrop-blur-sm border border-white/10 rounded-2xl px-6 py-3 mb-6">
            <div className="relative">
              <div className="w-12 h-12 rounded-xl bg-gradient-to-br from-blue-500 via-purple-500 to-cyan-500 flex items-center justify-center shadow-lg shadow-blue-500/30">
        ...
        >
          ...
          <a
            ...
            className="inline-flex items-center gap-2 px-8 py-4 bg-white/5 backdrop-blur-sm border border-white/10 rounded-2xl font-semibold text-lg text-white hover:bg-white/10 hover:border-white/20 transition-all duration-300 hover:scale-105"
          >
        ...
        >
          {[
            { label: 'Total Value Locked', value: 0, prefix: '$', suffix: '' },
            { label: '24h Volume', value: 0, prefix: '$', suffix: '' },
            { label: 'Transactions', value: 0, prefix: '', suffix: '' },
